  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        setSelected({
          exterior: exteriorsData.find(ext => ext.name === carData.exterior) || null,
          roof: roofsData.find(r => r.name === carData.roof) || null,
          wheels: wheelsData.find(w => w.name === carData.wheels) || null,
          interior: interiorsData.find(i => i.name === carData.interior) || null,
        })
      } catch (err) {
        console.error('Error loading car or features:', err)
      }
    }
  ...
  return (
    <div className="create-car">
      ...
      <form onSubmit={handleSubmit} className="create-car-name">
        ...
        />
        <input type="submit" className="create-car-button" value="Save Changes" />
      </form>
    </div>
  )
}
